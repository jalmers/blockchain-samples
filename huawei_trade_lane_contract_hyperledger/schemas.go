...
var schemas = `
{
    "API": {
        "createAsset": {
            "description": "Create an asset. One argument, a JSON encoded event. ID is required with zero or more writable properties. Establishes an initial asset state.",
            "properties": {
                "args": {
                    "description": "args are JSON encoded strings",
                    "items": {
                        "description": "A set of fields that constitute the writable fields in an asset's state. ID is mandatory along with at least one writable field. In this contract pattern, a partial state is used as an event.",
                        "properties": {
                            "ID": {
        ...
        "deletePropertiesFromAsset": {
            "description": "Delete one or more properties from an asset. Argument is a JSON encoded string containing an ID and an array of qualified property names. An example would be {'ID':'A1',['event.common.carrier', 'event.customer.temperature']} and the result of that invoke would be the removal of the carrier field and the temperature field with a recalculation of the alert and compliance status.",
            "properties": {
                "args": {
                    "description": "args are JSON encoded strings",
                    "items": {
                        "description": "Requested ID with a list or qualified property names.",
                        "properties": {
                            "ID": {
                                "description": "The ID of a managed asset. The resource focal point for a smart contract.",
                                "type": "string"
        ...
        "readAllAssets": {
            "description": "Returns the state of all assets as an array of JSON encoded strings. Accepts no arguments. For each managed asset, the state is read from the ledger and added to the returned array. Array is sorted by ID.",
            "properties": {
                "args": {
                    "description": "accepts no arguments",
                    "items": {},
        ...
        "readAsset": {
            "description": "Returns the state an asset. Argument is a JSON encoded string. ID is the only accepted property.",
            "properties": {
                "args": {
                    "description": "args are JSON encoded strings",
                    "items": {
        ...
        "readAssetHistory": {
            "description": "Requests a specified number of history states for an assets. Returns an array of states sorted with the most recent first. ID is required and count is optional. A missing count, a count of zero, or too large a count returns all existing history states.",
            "properties": {
                "args": {
                    "description": "args are JSON encoded strings",
                    "items": {
        ...
        "setCreateOnUpdate": {
            "description": "Allow updateAsset to redirect to createAsset when ID does not exist.",
            "properties": {
                "args": {
        ...
        "updateAsset": {
            "description": "Update the state of an asset. The one argument is a JSON encoded event. ID is required along with one or more writable properties. Establishes the next asset state. ",
            "properties": {
                "args": {
                    "description": "args are JSON encoded strings",
                    "items": {
